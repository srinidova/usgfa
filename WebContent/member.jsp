	...
	<div class="about_team">
		<div class="container">
			<div class="row">
					...
					<div class="member_pera">
						<div id="page">
							<div class="block showmore_one">
								...
								<p>
									...
									Journal” sent at active member’s registered address by post on
									regular basis. Member free LOGIN facility at Association
								...
								<p>Members can Tag their animals, take a picture of their
									...
									etc.</p>
								<p>Members would have free access to the members’ area where
									they can find and download useful information on various topics
									of successful farm management. Members willing to set up farms
									under various government Schemes would be offered subsidized
									cost Project Reports (Rs. 7,500 – 15,000) depending on the size
									of the farm, receive a certificate from the Association of the
									authenticity of the project report. Technical questions asked
									by Banks would be answered by Technical Experts of the
									Association. Member farmers would have the privilege to request
									the association to provide technical training to 2 persons
									nominated by them for their farms which would cover training to
									Farm Supervisors and Farm General Purpose Assistants.</p>
						...
						<div id="page">
							<div class="block showmore_one">
								...
								<p>
									Membership in the Core Group National Committees formulated by
									the Association to represent at various Ministries and
									Departments of Union Government of India.


									<p>Listing of the name as Life Member on all magazines / Website / Event Directories.</p>
              <p>Enlistment as a Professional Trainer in the Association registry recognized by HRD Ministry.</p>
              <p>Invitation at selective Industry interaction meets / government representations / seminars / exhibitions held on National level. 
              ...
              <p>Free life subscription of Association’s magazine “Goat & Sheep Journal” 
                ...
                Chair a technical session of interest during various Seminars / Farmers Trainings / Symposiums, etc. </p>
              <p>Tailor made Golden collar badges allowing 24X7 access to VIP sections / lounges with privilege to attend Lunches / Dinners with Guest of Honors. 
                ...
                Listing of the Life Member’s farm as a recognized Skill Development cum Training Centre at the Association website. </p>
              <p>All other rights of an ordinary member</p>
            </div>
          </div>
        </div>
        <div class="member_register_button">
         <a href='memberReg.jsp'> <button type="button" class="btn btn-success" >Register</button></a>
        </div>
      </div>
    </div>
  </div>
