								...
								<table
									...
									<tbody>
										<tr>
											...
											<td><div id="eventProfEventName"></div>
											<input type="hidden"
											class="form-control" id="eventProfEventId"
										...
										<tr>
											<td><b>Address:</b></td>
											<td><div id = "eventProfAddress"></div>
												<!-- <span id="eventProf_address"></span>, <span id="eventProf_place"></span></br> 
