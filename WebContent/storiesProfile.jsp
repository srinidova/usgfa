  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-10 toppad" >
      <div class="panel panel-info">
              ...
              <table class="table table-user-information  table-bordered table-responsive">
                <tbody>
                  <tr>
                    ...
                    <td><div id = "storiesProfName"></div>
                    <input type="hidden"class="form-control" id="storiesProfStoriesId"
        ...
        <div class="panel-footer"> <span > <a href="storiesEdit.jsp" onClick ="editProfStories()"data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a> </span> </div>
      </div>
    </div>
  </div>
</div>
